...
class RubberBottomSheetState extends State<RubberBottomSheet>
  ...
  double get _bottomSheetHeight {
    final RenderBox renderBox = _keyWidget.currentContext!.findRenderObject() as RenderBox;
  ...
  bool _draggingPeak(Offset? globalPosition) {
    ...
    final RenderBox renderBoxRed = _keyPeak.currentContext!.findRenderObject() as RenderBox;
